...
def fake_analyze_google_doc(drive_service, docs_service, drive_file_id, user_email, creds=None):
    return {
        "status": "analyzed",
...
def test_process_project_files_stores_revisions(sqlite_conn):
    process_project_files(sqlite_conn, creds=None, drive_service=None, docs_service=None, user_id=1, project_name="proj", user_email="user@example.com")
...
def test_analyze_drive_file_returns_expected_structure():
    result = analyze_drive_file(creds=None, drive_service=None, docs_service=None, conn=None, user_id="user@example.com", project_name="proj",
