...
def build_resume_snapshot_data(
    ...
    # Always store unfiltered skills in the snapshot; filtering happens at read/export time
    # via get_resume_by_id and export routes.
    ...
    rendered = render_snapshot(
        conn, user_id, snapshot, print_output=print_output,
